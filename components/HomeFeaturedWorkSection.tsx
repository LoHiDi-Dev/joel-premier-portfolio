      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        >
          <SectionHeading
            ...
            title="Featured Work"
            description={'Selected case studies across retail, healthcare, travel, and enterprise product design — focused on clarity, systems thinking, and measurable usability improvements.'}
          />
        </motion.div>
        ...
        >
          <Link
            href="/work"
            className="group inline-flex h-11 w-full items-center justify-center gap-1 rounded-full bg-[#171717] px-4 text-[11px] font-medium text-white shadow-sm transition-opacity duration-200 hover:opacity-90 focus:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#171717] focus:ring-offset-2 sm:h-10 sm:w-auto sm:gap-2 sm:px-6 sm:text-xs md:h-14 md:px-8 md:text-base"
          >
            View All Work
            <span
              aria-hidden="true"
